...
class MetaA2Cstar(MetaA2C):
  ...
  def train(self):
    ...
    for t in range(1, self.iterations+1):
      ...
      # Update meta parameter (pass meta_param for transformations like weight_decay)
      meta_param_update, self.meta_optim_state = self.meta_optim.update(meta_grad, self.meta_optim_state, self.meta_param)
