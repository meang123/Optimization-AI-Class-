...
from agents.MetaPPO import TrainingState


class MetaPPOstar(PPO):
  '''
  ...
  def train(self):
    ...
    meta_param = agent_optim.get_optim_param()
    ...
    agent_grad_update_fn = star_gradients.gradient_update_fn_with_optim_param(agent_loss_fn, agent_optim, pmap_axis_name=None, has_aux=True)
    ...
    def meta_training_step(meta_param, meta_optim_state, training_state, env_state, key):
      ...
      # Update optim_param with meta_param outside this function
    ...
    for t in range(1, self.iterations+1):
      ...
      agent_optim.reset_optimizer(meta_param)
      # Show log
